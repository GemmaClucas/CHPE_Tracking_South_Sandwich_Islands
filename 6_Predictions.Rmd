...
I also need to make a new raster with the correct resolution and extent of the study area, which I will use to rasterise the 1km grid with.
```{r}
# new raster in LAEA
...
Looks good. There is no jumping in point for the chinstraps in the northeast (as far as we know) and that is reflected in the distance raster.
...
Convert ```All_1KmPoints``` into a raster for plotting, using the raster created above.
```{r}
