...
I've added a line to change all distances that are over 100000 to be exactly 100000, but this is still allowing the penguins to travel further from the colony.
```{r}
...
I can't just sum up all the individual raster layers and plot, because the distributions around Thule, Cook, and Bellingshausen overlap so much.
