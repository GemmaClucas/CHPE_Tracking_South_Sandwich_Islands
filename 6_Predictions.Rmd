...
I want to calculate the importance of each cell by dividing its value (the probability of occurrence of a penguin) by the sum of the probability of occurences across all cells in that raster, and then multiply by the colony size. This will give the expected number of individuals that would forage in that cell.
...
What are the units for the predicted number of penguins? I think I need to plot in LAEA to be able to say the plotted values predict x penguins per km (or whatever).
