...
track.move <- track %>% 
  df2move(., proj = CRS("+proj=laea +lon_0=-26 +lat_0=-58 +units=m"), x = "LON", y = "LAT", time = "unique_time")

# track %>% filter(time == "2020-01-06 16:53:00 UTC")
```
...
THIS ISN'T WORKING, I THINK THERE IS A FUNKY FIX IN THERE IF YOU LOOK AT ```summary(track.move@data$y)```
```{r}
