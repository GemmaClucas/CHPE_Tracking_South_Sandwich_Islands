...
I have downloaded the data for January and February combined, so I only need to read in one netcdf file.

The dataset includes chlorophyll A and estimated phytoplankton concentration. Since these essentially measure the same thing, I am only going to include chlorophyll A. 
```{r}
...
2. Add layers for values at depth? The layers looks really similar to sea surface - don't add?
