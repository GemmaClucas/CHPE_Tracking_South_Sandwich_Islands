...
Need to update this so that they can't travel through land.
...
UPDATE THIS TO THE 750M DEPTH CONTOUR 

So I need to make a raster that includes the distance to the shelf break from all points in the study area. 
...
VICKY IS GOING TO LOOK FOR HER CODE ABOUT HOW TO MAKE THE DISTANCE FROM COLONY RASTER WITHOUT LETTING THEM GO THROUGH LAND, THIS WOULD THEN PROBABLY PICK OUT A PIECE OF SHELF BREAK THAT IS DUE EAST OF THE COLONY.

NEXT, WORK OUT THE BEARING TO THIS NEAREST BIT OF SHELF BREAK FROM EVERY FIX.
