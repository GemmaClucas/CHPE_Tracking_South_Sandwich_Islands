...
calc_avg_speed <- function(x){
  x2 <- x %>% 
    ...
    group_modify(single_group_avg_speed)
...
![](2_split_into_trips_files/figure-gfm/unnamed-chunk-15-3.png)<!-- -->
