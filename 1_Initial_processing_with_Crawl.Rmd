...
Also, wrap everything up into functions so that I can repeat this easily for other penguins.
...
2. What are the units of the speed filter - is it km/hr? What is the justification for setting it to 8?
3. 
