...
While all are significantly correlated with one another, the covariates with correlation coefficient  >|0.7| are:

1. Depth and distance to the shelf break (-0.8)
2. Distance to the shelf break and distance to the colony (0.78)

So if I drop distance to the shelf break, then I can keep depth and distance to the colony.
