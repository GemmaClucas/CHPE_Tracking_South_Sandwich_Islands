...
mask <- projectRaster(mask, crs = CRS("+proj=laea +lon_0=-26 +lat_0=-58 +units=m"))

mask <- aggregate(mask, fact = 5)

mask <- projectRaster(mask, crs = crs("+init=epsg:4326"))
...
STILL NEED TO FIGURE OUT HOW TO SAMPLE THESE.