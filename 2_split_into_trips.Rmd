...
**Something is going wrong here and I can't work out what. It seems like when the track crosses (100000, -200000) it gets cropped, why?**
...
Start_row_indexes <- as.list(which(at_sea$Start_trip == TRUE))
```
**Again the final long trip is getting cropped, also when it passes 100000. Why?**
...
Why are the ends of my trips being cut? something is happening at -200000, -100000 I think.

It would be good to print the start date and time of the trip, and the duration, onto each graph to see whether they make sense.