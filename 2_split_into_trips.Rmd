...
At the moment average speed is calculated in 3 hour windows. This takes the SpatialPointsDataFrame ```at_sea``` which has always been filtered to keep only points off the island.
