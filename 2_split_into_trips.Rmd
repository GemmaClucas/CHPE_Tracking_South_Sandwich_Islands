...
Also a bit odd. Not much data from this one and it looks like it returns to some point to the east of the island, as if all fixes are offset by some distance to the east towards the end of the observation period. Therefore splitting trips doesn't work well.
