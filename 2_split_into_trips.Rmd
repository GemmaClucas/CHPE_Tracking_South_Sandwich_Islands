...
I am estimating the average speed over a sliding window of 3 hours at the mo, so that I'm not filtering out times when the birds are resting between dives. Take a look at this further - there are some times when the speed is either NaN or Inf because an observation and predicted location occur at exactly the same time - nudge times to be off by a few seconds when this occurs?
